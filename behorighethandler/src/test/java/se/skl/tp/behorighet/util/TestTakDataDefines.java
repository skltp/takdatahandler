...
public class TestTakDataDefines {
  ...
  public static final String RECEIVER_2_RECEIVER_3_RECEIVER_4 = String.format("%s#%s#%s", RECEIVER_2, RECEIVER_3, RECEIVER_4);
  public static final String RECEIVER_4_RECEIVER_3_RECEIVER_2 = String.format("%s#%s#%s", RECEIVER_4, RECEIVER_3, RECEIVER_2);
